...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-opg-139-m-n-cycle-covers-a0562289-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/OPG-139"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-opg-139-m-n-cycle-covers-a0562289-v1",
      "problem_contract_sha256": "4ecff76963308293763418381e74a4b3e6de9e8238602c6a3ea0b1687143f96d",
      "problem_id": "problem:um-opg-139-m-n-cycle-covers-a0562289",
      "route_id": "route:um-opg-139-m-n-cycle-covers-a0562289-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-opg-139-m-n-cycle-covers-a0562289-source-fidelity-01",
      "graph_id": "graph:um-opg-139-m-n-cycle-covers-a0562289-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-opg-139-m-n-cycle-covers-a0562289-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-opg-139-m-n-cycle-covers-a0562289-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Conjecture Every bridgeless graph has a (5,2)-cycle-cover."
          },
          "statement_sha256": "f084f0312ebdfb7e4625a68a015e3665c64d636fd129cf9f84fe920f1b751e6d"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-opg-139-m-n-cycle-covers-a0562289-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-opg-139-m-n-cycle-covers-a0562289-root",
      "route_id": "route:um-opg-139-m-n-cycle-covers-a0562289-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-opg-139-6e38ad23cc72",
        "url": "https://www.unsolvedmath.com/problems/OPG-139"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
